  ...
  return (
    ...
    >
      <div className="container-max space-y-12">
        ...
        />
        <Reveal delay={0.1} className="grid gap-10 rounded-3xl border border-white/5 bg-surface/80 p-8 shadow-xl shadow-black/20 lg:grid-cols-[2fr,1fr]">
          <div className="space-y-6 text-base text-textMuted">
            <p>{contact.copy}</p>
            <div className="flex flex-col gap-3 text-sm text-textMuted/80">
